...
public class PolygonStudentsTester {
	...
	public static void teachersTester() {
	...
	public static void student1Test() {

        Polygon polygon = new Polygon();
        polygon.addVertex(2.0, 1.0);
        polygon.addVertex(5, 0.1);
        polygon.addVertex(5, -6);
        polygon.addVertex(4, 6);
        polygon.addVertex(3, 5);
        polygon.addVertex(0.5, 3);
        
        System.out.println(polygon);
        System.out.println("avilable? " + polygon.addVertex(1.0,3));
        
        System.out.println("After Insert" + polygon);


        Point highest = polygon.highestVertex();
        //System.out.println("highiest: " + highest); 
        
        System.out.println("peri: " + polygon.calcPerimeter());
        System.out.println("area: " + polygon.calcArea());
        
        Polygon biggerPolygon = new Polygon();
        biggerPolygon.addVertex(2.0, 1.0);
        biggerPolygon.addVertex(5, 0);
        biggerPolygon.addVertex(2, 6);
        biggerPolygon.addVertex(4, 6);
        biggerPolygon.addVertex(3, 5);
        biggerPolygon.addVertex(1, 3);

        System.out.println("Bigger Data");
        System.out.println(" peri: " + biggerPolygon.calcPerimeter());
        System.out.println("area: " + biggerPolygon.calcArea());
        
        
        System.out.println("Original polygon is bigger? " + polygon.isBigger(biggerPolygon));
             
        Point point = new Point(4, 6);
        System.out.println("index? " + polygon.findVertex(point));
        System.out.println("next vertex: " + polygon.getNextVertex(point));
