...
public class PolygonTester {
        ...
        else 
        {
            if(actual instanceof toStringErrorCode)
            {
                ...
                case Exception:
                    ...
                    break;
                case Parenthesis:
                    System.out.println("Found invalid amount of parentheses!");
                    break;
                case Comma:
                    System.out.println("Found invalid amount of commas!");
                    break;
                case Length: default:
    ...
    public static
    boolean check_parenthesis(String text, Point... points)
    {
        final int ParenthesisAmount = (points.length * 2) + 2;
        ...
        return parenthesis_counter == ParenthesisAmount;
    }

    public static
    boolean check_commas(String text, Point... points)
    {
        final int CommaAmount = (points.length * 2) - 1;
        ...
        return comma_counter == CommaAmount;
    }
    ...
    toStringErrorCode check_toString(String text, Point... points)
    {
        ...
        try 
        {
            if(!check_parenthesis(text, points))
                return toStringErrorCode.Parenthesis;

            if(!check_commas(text, points))
                return toStringErrorCode.Comma;
    ...
    void main(String[] args)
    {
        ...
        System.out.println("---------------------------------- Convex Polygon -----------------------------");
        {
            ...
            System.out.println(convex_polygon);
            // begin tests
